...
class CommonDriver(object):
    ...
    def current_version(self):
        raise NotImplementedError('WebDriver extension must implement current_version method')
    ...
    def update(self):
        ...
        if not self.desired_version():
            raise Exception(f"Unable to find the latest version of {self.file_name()}; "
    ...
    def install_dir(self):
        return os.getenv('WEBDRIVERS_INSTALL_DIR') \
               or os.path.abspath(os.path.join(os.getenv('HOME'), '.webdrivers'))
